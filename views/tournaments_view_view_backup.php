...
<form method="post" id="tournament-change-form">
		...
		<table id="tournament-attributes-table">
				...
				<tr>
					...
					<td><input class="spinner" min="1" maxlength="2" name="tournament[tournament_group]"
					           onkeypress="validate(event)"value="<?=$tournament['tournament_group']?>"/></td>
				</tr>
				<tr>
	...
	<div class="row-fluid">
		<div class="span12 text-center">
			...
			<button class="btn btn-large btn-primary" type="submit">Salvesta</button>
